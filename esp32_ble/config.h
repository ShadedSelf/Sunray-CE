...
#define WIFI_STA_SSID   "LerpMow"      // WiFi SSID      (leave empty ("") to not use WiFi)
#define WIFI_STA_PSK    "eresmowao23"  // WiFi password  (leave empty ("") to not use WiFi)
...
#define MQTT_HOSTNAME   "192.168.0.231"  // IP or hostname (example: "192.168.2.60")
#define MQTT_PORT       1883
#define MQTT_CLIENT_ID  NAME
#define MQTT_USERNAME   "a"
