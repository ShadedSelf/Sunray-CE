...
#define TICKS_PER_REVOLUTION  1300 / 2 / 4   // 1194/2  odometry ticks per wheel revolution
...
#define WIFI_SSID "LerpMow"            // choose WiFi network ID
#define WIFI_PASS "eresmowao23"      // choose WiFi network password
